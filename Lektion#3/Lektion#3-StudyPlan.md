# 📝 Lektion 3 - Studienplan (Study Plan)

## 📋 Übersicht (Overview)

Dieser Studienplan führt Sie durch die vereinfachten Lernmaterialien für Lektion 3 und bietet eine strukturierte Herangehensweise, um die Vokabeln und Grammatik effektiv zu lernen.

This study plan guides you through the simplified learning materials for Lesson 3 and provides a structured approach to effectively learn the vocabulary and grammar.
...
1. **Core/Grammar.md**
   - Enthält alle Grammatikregeln: Passiv mit Modalverben, Genitiv, Bruchzahlen und Kommunikationsphrasen
   - Contains all grammar rules: passive with modal verbs, genitive case, fractions, and communication phrases
...
Viel Erfolg beim Lernen von Lektion 3! Passen Sie diesen Plan an Ihre Bedürfnisse an und genießen Sie den Prozess des Deutschlernens.

Good luck with learning Lesson 3! Adapt this plan to your needs and enjoy the process of learning German.
