# 📚 Lektion X - Lernmaterialien (Learning Materials)

## 📋 Übersicht (Overview)

Dieses Verzeichnis enthält alle Lernmaterialien für Lektion X des Schritte B1.1 Kurses. Die Materialien sind in einer einfachen, benutzerfreundlichen Struktur organisiert, um ein effizientes und angenehmes Lernerlebnis zu ermöglichen.

This directory contains all learning materials for Lesson X of the Schritte B1.1 course. The materials are organized in a simple, user-friendly structure to enable an efficient and enjoyable learning experience.
...
│
├── Lektion#X-StudyPlan.md        # Detaillierter Studienplan (Detailed study plan)
...
- **Grammar.md**: Enthält alle Grammatikregeln der Lektion ([GRAMMATIK-THEMEN HIER EINFÜGEN]) in einer klaren, übersichtlichen Darstellung mit Beispielen und Erklärungen.

- **Vocabulary.md**: Enthält alle Vokabeln der Lektion, thematisch geordnet mit Beispielen und Übersetzungen. Die Vokabeln sind in Kategorien wie "[KATEGORIE 1]", "[KATEGORIE 2]", "[KATEGORIE 3]" und "[KATEGORIE 4]" eingeteilt.

### 📝 Übungsmaterialien (Practice Materials)

- **Story.md**: Eine Geschichte über [HAUPTFIGUR], die alle Vokabeln und Grammatikstrukturen der Lektion in einem zusammenhängenden Kontext verwendet. Die Geschichte ist mit dem einheitlichen Farbkodierungssystem versehen, um das Verständnis zu erleichtern.

- **Dialogs.md**: Realistische Dialogszenarien zum Üben der Konversation in verschiedenen Kontexten wie [KONTEXT 1], [KONTEXT 2], [KONTEXT 3] und [KONTEXT 4]. Auch hier wird das einheitliche Farbkodierungssystem verwendet.
...
- **Lektion#X-StudyPlan.md**: Ein detaillierter Studienplan, der erklärt, wie die verschiedenen Materialien am besten genutzt werden können, mit einem empfohlenen 4-Stunden-Lernplan.
...
Viel Erfolg beim Lernen von Lektion X!

Good luck with learning Lesson X!
